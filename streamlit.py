...
# service parameters
CORTEX_SEARCH_DATABASE = "SEI_MEDICAL_DENTAL"
...
def main():
    ...
    st.title(f":speech_balloon: Chat Document Assistant for SEI Medical and Dental insurance with Snowflake Cortex")
    ...
    question = st.text_input("Enter question", placeholder="How much are standard braces for my kid?", label_visibility="collapsed")
